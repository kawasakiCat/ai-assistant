...
export const scenarios = [
	{
	  "id": "welcome",
	  "message": "こんにちは！私はあなたの就活アシスタントです。就職活動は挑戦の連続ですが、私が全力でサポートしますので、一緒に前進しましょう！何をお手伝いしましょうか？",
	  "options": [
	...
	},
	{
	  ...
	  "message": "この志望動機の文章を保存する場合はコピーしてください。次はどうしますか？",
	  "options": [
	...
	},
	{
		...
		"message": "この自己PRの文章を保存する場合はコピーしてください。次はどうしますか？",
		"options": [
		  { "text": "続けて作成する", "next": "menu" },
		  { "text": "終了する", "next": "goodbye" }
		]
